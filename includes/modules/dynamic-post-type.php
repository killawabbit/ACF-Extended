    ...
    'fields' => array(
        ...
        array(
            ...
            'choices' => array(
                ...
                'author' => __('Author', 'acfe'),
                'thumbnail' => __('Thumbnail', 'acfe'),
                'excerpt' => __('Excerpt', 'acfe'),
                'trackbacks' => __('Trackbacks', 'acfe'),
                'custom-fields' => __('Custom fields', 'acfe'),
                'comments' => __('Comments', 'acfe'),
                'revisions' => __('Revisions', 'acfe'),
                'page-attributes' => __('Page attributes', 'acfe'),
                'post-formats' => __('Post formats', 'acfe'),
            ),
            'allow_custom' => 1,
            'save_custom' => 1,
            'default_value' => array(
